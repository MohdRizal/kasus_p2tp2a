...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/fa/css/font-awesome.css" />
	...
	<div class="jumbotron home home-fullscreen" id="home">
		...
		<a href="#" class="logo">
			<!--<img src="img/logo.png" alt="Moderno - Theme by GraphBerry.com">-->
                        <img src="style/img/logoo.png" height="100" width="100">
		</a>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="service-item">
                                            <a href=""><div class="icon"><i class="fa fa-bookmark"></i></div></a>
                                            <a href=""><h3>Laporkan Kasus Anda</h3></a>
						<p>Klik logo diatas untuk melaporkan kasus kekerasan pada
                                                    anak dan wanita di sekitar anda
						</p>
					</div>
				</div>
				<div class="col-md-4">
